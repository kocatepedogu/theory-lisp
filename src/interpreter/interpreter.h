...
#ifndef THEORYLISP_INTERPRETER_INTERPRETER_H
#define THEORYLISP_INTERPRETER_INTERPRETER_H
 ...
 */
objectptr interpreter(listptr parse_tree, bool verbose, bool show, stack_frame_ptr sf);
